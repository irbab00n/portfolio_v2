module.exports = [
  {
    ...
    stackImage: '',
    description: 'After some small introduction to Three.js and the world of WebGL, I came across Particles.js.  It\'s a simple library that you can use to quickly create an interactive feature in your web application.  It inspired me to try building a small web app that would also be a practice in creating mobile responsive layouts through CSS classes.  In the process, I had an idea to create a dynamic simulated scroll target menu that will change depending on the number of content sections you build into your website.',
